...
// 唯一的 CImageTransferApp 对象

CImageTransferApp theApp;


// CImageTransferApp 初始化
...
BOOL CImageTransferApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CImageTransferDoc),
		RUNTIME_CLASS(CMainFrame),       // 主 SDI 框架窗口
		RUNTIME_CLASS(CImageTransferView));
	if (!pDocTemplate)
		return FALSE;
